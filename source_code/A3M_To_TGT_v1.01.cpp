...
// structural info
	...
	fout.close();	
	string fin_combine="";
	fin_combine = fin_combine + home_root + "/util/combine_file.sh "+temporary_root+"/"+targetName+".ss2 "+temporary_root+"/"+targetName+".ss8 "+temporary_root+"/"+targetName+".acc "+output_tgt;
